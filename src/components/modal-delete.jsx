export const DeleteModal = ({ onConfirm, onCancel }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
    <div className="bg-white p-7 rounded-lg max-w-[400px] w-full shadow-lg">
      ...
      <div className="flex gap-4">
        <button
          onClick={onCancel}
          className="flex-1 bg-gray-400 text-white py-3 rounded-lg font-semibold uppercase hover:opacity-70 transition-opacity"
        >
          No, cancel
        </button>
        <button
